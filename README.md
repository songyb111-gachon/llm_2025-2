...
| 모델 | Simple | Strict | Hybrid | All | Harm | Avg | CRIT | 생성 JB | 생성 Harm | 시간 |
|------|--------|--------|--------|-----|------|-----|------|---------|-----------|------|
...
```bash
# 수동 다운로드
wget https://raw.githubusercontent.com/JailbreakBench/artifacts/main/attack-artifacts/GCG/white_box/vicuna-13b-v1.5.json

# 또는
curl -O https://raw.githubusercontent.com/JailbreakBench/artifacts/main/attack-artifacts/GCG/white_box/vicuna-13b-v1.5.json
```
